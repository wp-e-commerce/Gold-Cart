...
4. Open the Products > Upgrade page and under Gold Cart enter the Name and API Key provided in your Purchase Receipt
...
Documentation: http://getshopped.org/resources/docs/
